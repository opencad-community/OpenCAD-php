						...
						<div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
							<div class="card-body text-center">
								<div>
									<h2>Sign up</h2>
									<p>I am a...</p>   
									<button class="btn btn-primary active mt-3" type="button" data-toggle="modal" data-target="#registerFirstResponder">First Responder</button><br />
									<button class="btn btn-primary active mt-3" type="button" data-toggle="modal" data-target="#registerCivilian">Civilian</>
								</div>
							</div>
						</div>
					</div>
