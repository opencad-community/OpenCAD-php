    ...
    <ul class="nav navbar">
        ...
        { ?>
        <li class="nav-item" <?php if ( $pageName == "User Manager") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-admin/userManagement.php"><i class="fas fa-database fa-3px " style="color:black"></i> <?php echo lang_key("USER_MANAGER"); ?></a></li>
      <?php  } else { }?>
        <?php if ( ( MODERATOR_NCIC_EDITOR == true && $_SESSION['admin_privilege'] == 2 ) || ( $_SESSION['admin_privilege'] == 3 ) )
        { ?>
        <li class="nav-item" <?php if ( $pageName == "NCIC Editor") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-admin/ncicAdmin.php"><i class="fas fa-database fa-3px"></i> <?php echo lang_key("NCIC_EDITOR"); ?></a></li>
      <?php  } else { }?>
      <?php if ( ( MODERATOR_DATA_MANAGER == true && $_SESSION['admin_privilege'] == 2 ) || ( $_SESSION['admin_privilege'] == 3 ) )
        ...
        <?php  } else { }?>
        <li class="nav-item" <?php if ( $pageName == "About OpenCAD") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-admin/about.php"><i class="fas fa-info-circle fa-3px" style="color:black"></i> About OpenCAD</a></li>
