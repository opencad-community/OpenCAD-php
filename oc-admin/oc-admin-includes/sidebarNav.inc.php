    ...
    <ul class="nav navbar-nav d-md-down-none">
      ...
      <?php  } else { }?>
        ...
        { ?>
        <li class="nav-item px-3" <?php if ( $pageName == "NCIC Editor") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-admin/ncicAdmin.php"><i class="fas fa-database fa-3px" style="color:black""></i> NCIC Editor</a></li>
      <?php  } else { }?>
