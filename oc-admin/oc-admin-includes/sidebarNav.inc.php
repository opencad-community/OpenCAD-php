...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
        <li <?php if ( $pageName == "Dashboard") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/admin.php"><i class="fas fa-home"></i>  Dashboard</a></li>
        <li <?php if ( $pageName == "User Management") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/userManagement.php"><i class="fas fa-user"></i> User Management</a></li>
        <?php if ( ( MODERATOR_NCIC_EDITOR == true && $_SESSION['admin_privilege'] == 2 ) || ( $_SESSION['admin_privilege'] == 3 ) )
        { ?>
        <li <?php if ( $pageName == "NCIC Editor") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/ncicAdmin.php"><i class="fas fa-database"></i> NCIC Editor</a></li>
      <?php  } else { }?>
      ...
      <li>
          ...
          <ul class="nav child_menu">
            ...
            <li <?php if ( $pageName == "Citation Types Manager") echo $currentPage; if (MODERATOR_DATAMAN_CITATIONTYPES == false) echo "onclick=\"return false\""; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/dataManagement/citationTypeManager.php"><i class="fas fa-exclamation-triangle"></i> Citation Types Manager</a></li>
            <li <?php if ( $pageName == "Departments Manager") echo $currentPage; if (MODERATOR_DATAMAN_CITATIONTYPES == false) echo "onclick=\"return false\""; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/dataManagement/departmentsManager.php"><i class="fas fa-exclamation-triangle"></i> Departments Manager</a></li>
            <li <?php if ( $pageName == "Incident Types Manager") echo $currentPage; if (MODERATOR_DATAMAN_INCIDENTTYPES == false) echo "onclick=\"return false\"";  ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/dataManagement/incidentTypeManager.php" disabled><i class="fas fa-shield-alt"></i> Incident Types Manager</a></li>
        ...
        <li <?php if ( $pageName == "About OpenCAD") echo $currentPage; ?>><a href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/oc-admin/about.php"><i class="fas fa-info-circle"></i> About OpenCAD</a></li>
      </li>
    </ul>
  </div>
  <!-- ./ menu_section -->
