...
<div class="modal fade" id="editWarningTypeModal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form role="form" method="post" action="<?php echo BASE_URL; ?>/actions/dataActions.php" class="form-horizontal" >
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  <span class="fas fa-exclamation-triangle form-control-feedback right" aria-hidden="true"></span>                </div>
                <!-- ./ col-sm-9 -->
              </div>
              <!-- ./ form-group -->>
          </div>
    ...
    $('#editWarningTypeModal').on('show.bs.modal', function(e) {
      var $modal = $(this), warningTypeID = e.relatedTarget.id;

      $.ajax({
          cache: false,
          type: 'POST',
          url: '<?php echo BASE_URL; ?>/actions/dataActions.php',
          data: {'getWarningTypeDetails': 'yes',
