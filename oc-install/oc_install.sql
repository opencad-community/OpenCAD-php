...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>ncicNames` (
  ...
  `weaponPermit` set('Unobtained','Vaild','Suspended','Expired','Canceled') DEFAULT NULL,
  `weaponPermit_type` set('Small Arms','Specialised Weapon','Automatic Weapon','Semi-Automatic','Military Grade') DEFAULT NULL,
  `weaponPermit_issuedBy` set('Ammu-Nation','Government','Military') DEFAULT NULL,
