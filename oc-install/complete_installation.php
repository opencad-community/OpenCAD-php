...
if ($passed_step == 10) {
	...
	$MODERATOR_EDIT_VEHICLES 			= isset($_SESSION['MODERATOR_EDIT_VEHICLES']) ? prepare_input($_SESSION['MODERATOR_EDIT_VEHICLES']) : '';
	$MODERATOR_DELETE_VEHICLES			= isset($_SESSION['MODERATOR_DELETE_VEHICLES']) ? prepare_input($_SESSION['MODERATOR_DELETE_VEHICLES']) : '';
	...
	$MODERATOR_EDIT_INCIDENTTYPES		= isset($_SESSION['MODERATOR_EDIT_INCIDENTTYPES']) ? prepare_input($_SESSION['MODERATOR_EDIT_INCIDENTTYPES']) : '';
	$MODERATOR_DELETE_INCIDENTTYPES		= isset($_SESSION['MODERATOR_DELETE_INCIDENTTYPES']) ? prepare_input($_SESSION['MODERATOR_DELETE_INCIDENTTYPES']) : '';
	$MODERATOR_EDIT_STREETS			    = isset($_SESSION['MODERATOR_EDIT_STREETS']) ? prepare_input($_SESSION['MODERATOR_EDIT_STREETS']) : '';
	$MODERATOR_DELETE_STREETS			= isset($_SESSION['MODERATOR_DELETE_STREETS']) ? prepare_input($_SESSION['MODERATOR_DELETE_STREETS']) : '';
	$MODERATOR_EDIT_WARRANTTYPES			= isset($_SESSION['MODERATOR_EDIT_WARRANTTYPES']) ? prepare_input($_SESSION['MODERATOR_EDIT_WARRANTTYPES']) : '';
	$MODERATOR_DELETE_WARRANTTYPES		= isset($_SESSION['MODERATOR_DELETE_WARRANTTYPES']) ? prepare_input($_SESSION['MODERATOR_DELETE_WARRANTTYPES']) : '';
	$MODERATOR_EDIT_WEAPONS			    = isset($_SESSION['MODERATOR_EDIT_WEAPONS']) ? prepare_input($_SESSION['MODERATOR_EDIT_WEAPONS']) : '';
	$MODERATOR_DELETE_WEAPONS			= isset($_SESSION['MODERATOR_DELETE_WEAPONS']) ? prepare_input($_SESSION['MODERATOR_DELETE_WEAPONS']) : '';		
	...
	$GTAV_DATA							= isset($_SESSION["GENERATE_GTAV_DATA"]) ? prepare_input($_SESSION["GENERATE_GTAV_DATA"]) : '';
			...
			if (EI_DATABASE_CREATE && ($install_type == 'create') && !$db->Create()) {
				...
				if (EI_CHECK_DB_MINIMUM_VERSION && (version_compare($db->GetVersion(), EI_DB_MINIMUM_VERSION, '<'))) {
					...
					if ($sql_dump != '' || $sql_dump = '' && $sql_dump_gta != '') {
						...
						$config_file = str_replace('<MODERATOR_EDIT_VEHICLES>', $MODERATOR_EDIT_VEHICLES, $config_file);
						$config_file = str_replace('<MODERATOR_DELETE_VEHICLES>', $MODERATOR_DELETE_VEHICLES, $config_file);
						...
						$config_file = str_replace('<MODERATOR_EDIT_INCIDENTTYPES>', $MODERATOR_EDIT_INCIDENTTYPES, $config_file);
						$config_file = str_replace('<MODERATOR_DELETE_INCIDENTTYPES>', $MODERATOR_DELETE_INCIDENTTYPES, $config_file);
						$config_file = str_replace('<MODERATOR_EDIT_STREETS>', $MODERATOR_EDIT_STREETS, $config_file);
						$config_file = str_replace('<MODERATOR_DELETE_STREETS>', $MODERATOR_DELETE_STREETS, $config_file);
						$config_file = str_replace('<MODERATOR_EDIT_WARRANTTYPES>', $MODERATOR_EDIT_WARRANTTYPES, $config_file);
						$config_file = str_replace('<MODERATOR_DELETE_WARRANTTYPES>', $MODERATOR_DELETE_WARRANTTYPES, $config_file);
						$config_file = str_replace('<MODERATOR_EDIT_WEAPONS>', $MODERATOR_EDIT_WEAPONS, $config_file);
						$config_file = str_replace('<MODERATOR_DELETE_WEAPONS>', $MODERATOR_DELETE_WEAPONS, $config_file);
