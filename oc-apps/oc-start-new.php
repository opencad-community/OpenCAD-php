...
$roadsideAssistButton = "";
    ...
    else if ($_SESSION['ems'] == 'YES')
    {
        $emsButton = "<a href=\"".BASE_URL."/".OCAPPS."/mdt.php?dep=ems\" class=\"btn btn-lg cusbtn animate fadeInLeft delay1\">EMS</a>";   
    }
    else if ($_SESSION['fire'] == 'YES')
    {
        $fireButton = "<a href=\"".BASE_URL."/".OCAPPS."/mdt.php?dep=fire\" class=\"btn btn-lg cusbtn animate fadeInLeft delay1\">Fire</a>";
    }
    else if ($_SESSION['highway'] == 'YES')
    {
        $highwayButton = "<li class=\"nav-item\"><a class=\"nav-link\" href=\"".BASE_URL."/".OCAPPS."/mdt.php?dep=highway\" class=\"btn btn-lg cusbtn animate fadeInLeft delay1\">Highway Patrol</a></li>";
    }
    else if ($_SESSION['police'] == 'YES')
    {
    ...
    else if ($_SESSION['dispatch'] == 'YES')
    {
        $dispatchButton = "<li class=\"nav-item\"><a class=\"nav-link\" href=\"".BASE_URL."/".OCAPPS."/cad.php\">Dispatch<i class=\"nav-icon icon-pencil\"></i> </a></li>";
    } 
    else if ($_SESSION['roadsideAssist'] == 'YES')
    {
