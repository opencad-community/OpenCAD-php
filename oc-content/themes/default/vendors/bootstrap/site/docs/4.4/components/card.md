...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <a rel="noopener" href="#" class="btn btn-primary">Go somewhere</a>
  </div>
</div>
{% endcapture %}
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a rel="noopener" href="#" class="card-link">Card link</a>
    <a rel="noopener" href="#" class="card-link">Another link</a>
  </div>
</div>
{% endcapture %}
{% include example.html content=example %}
...
<div class="card w-75">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
    <a rel="noopener" href="#" class="btn btn-primary">Button</a>
  </div>
</div>
