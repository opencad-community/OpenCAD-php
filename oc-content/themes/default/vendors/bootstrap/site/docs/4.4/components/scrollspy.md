...
<div class="bd-example">
  <nav id="navbar-example2" class="navbar navbar-light bg-light">
    ...
    <ul class="nav nav-pills">
      <li class="nav-item">
        <a rel="noopener" class="nav-link" href="#fat">@fat</a>
      </li>
      <li class="nav-item">
        <a rel="noopener" class="nav-link" href="#mdo">@mdo</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a rel="noopener" class="dropdown-item" href="#one">one</a>
          <a rel="noopener" class="dropdown-item" href="#two">two</a>
          <div role="separator" class="dropdown-divider"></div>
          <a rel="noopener" class="dropdown-item" href="#three">three</a>
        </div>
      </li>
    </ul>
  </nav>
    ...
    <div class="col-4">
      <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column">
        ...
        <nav class="nav nav-pills flex-column">
          <a rel="noopener" class="nav-link" href="#item-1">Item 1</a>
          <nav class="nav nav-pills flex-column">
            <a rel="noopener" class="nav-link ml-3 my-1" href="#item-1-1">Item 1-1</a>
            <a rel="noopener" class="nav-link ml-3 my-1" href="#item-1-2">Item 1-2</a>
          </nav>
          <a rel="noopener" class="nav-link" href="#item-2">Item 2</a>
          <a rel="noopener" class="nav-link" href="#item-3">Item 3</a>
          <nav class="nav nav-pills flex-column">
            <a rel="noopener" class="nav-link ml-3 my-1" href="#item-3-1">Item 3-1</a>
            <a rel="noopener" class="nav-link ml-3 my-1" href="#item-3-2">Item 3-2</a>
          </nav>
        </nav>
      </nav>
    </div>
  ...
  <div class="row">
    <div class="col-4">
      <div id="list-example" class="list-group">
        <a rel="noopener" class="list-group-item list-group-item-action" href="#list-item-1">Item 1</a>
        <a rel="noopener" class="list-group-item list-group-item-action" href="#list-item-2">Item 2</a>
        <a rel="noopener" class="list-group-item list-group-item-action" href="#list-item-3">Item 3</a>
        <a rel="noopener" class="list-group-item list-group-item-action" href="#list-item-4">Item 4</a>
      </div>
    </div>
    <div class="col-8">
...
Navbar links must have resolvable id targets. For example, a `<a rel="noopener" href="#home">home</a>` must correspond to something in the DOM like `<div id="home"></div>`.
{% endcapture %}
