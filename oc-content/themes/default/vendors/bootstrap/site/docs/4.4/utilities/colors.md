...
{% capture example %}
{% for color in site.data.theme-colors %}
<p><a rel="noopener" href="#" class="text-{{ color.name }}{% if color.name == "light" %} bg-dark{% endif %}">{{ color.name | capitalize }} link</a></p>{% endfor %}
<p><a rel="noopener" href="#" class="text-muted">Muted link</a></p>
<p><a rel="noopener" href="#" class="text-white bg-dark">White link</a></p>
{% endcapture %}
{% include example.html content=example %}
