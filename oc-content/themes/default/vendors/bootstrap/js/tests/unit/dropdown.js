$(function () {
  ...
  QUnit.test('should not open dropdown if target is disabled via attribute', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        ...
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
  ...
  QUnit.test('should not add class position-static to dropdown if boundary not set', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
        '<a rel="noopener" class="dropdown-item" href="#">Something else here</a>' +
        '</div>' +
  ...
  QUnit.test('should add class position-static to dropdown if boundary not scrollParent', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" data-toggle="dropdown" data-boundary="viewport">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
        '<a rel="noopener" class="dropdown-item" href="#">Something else here</a>' +
        '</div>' +
  ...
  QUnit.test('should set aria-expanded="true" on target when dropdown menu is shown', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
        '<a rel="noopener" class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('should set aria-expanded="false" on target when dropdown menu is hidden', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" aria-expanded="false" data-toggle="dropdown">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
        '<a rel="noopener" class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('should remove "show" class if body is clicked, with multiple dropdowns', function (assert) {
    ...
    var dropdownHTML = '<div class="nav">' +
        ...
        '<a rel="noopener" class="dropdown-toggle" data-toggle="dropdown" href="#testmenu">Test menu <span class="caret"/></a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#sub1">Submenu 1</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="btn-group">' +
        ...
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Action 1</a>' +
        '</div>' +
        '</div>'
  ...
  QUnit.test('should skip disabled element when using keyboard navigation', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        ...
        '<a rel="noopener" href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item disabled" href="#">Disabled link</a>' +
  ...
  QUnit.test('Dropdown should not use Popper.js in navbar', function (assert) {
    ...
    var html = '<nav class="navbar navbar-expand-md navbar-light bg-light">' +
        '<div class="dropdown">' +
        '  <a rel="noopener" class="nav-link dropdown-toggle" href="#" id="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>' +
  ...
  QUnit.test('should close dropdown and set focus back to toggle when escape is pressed while focused on a dropdown item', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" id="toggle" data-toggle="dropdown">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" id="item" href="#">Menu item</a>' +
        '</div>' +
        '</div>'
    var $dropdown = $(dropdownHTML)
      .appendTo('#qunit-fixture')
  ...
  QUnit.test('should not use Popper.js if display set to static', function (assert) {
    ...
    var dropdownHTML =
        '<div class="dropdown">' +
        '<a rel="noopener" href="#" class="dropdown-toggle" data-toggle="dropdown" data-display="static">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item" href="#">Secondary link</a>' +
        '<a rel="noopener" class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('it should skip hidden element when using keyboard navigation', function (assert) {
    ...
    var fixtureHtml = [
      ...
      '    <a rel="noopener" class="dropdown-item" href="#sub1" style="display: none">Hidden link</a>',
      '    <a rel="noopener" class="dropdown-item" href="#sub1" style="visibility: hidden">Hidden link</a>',
      '    <a id="item1" class="dropdown-item" href="#">Another link</a>',
      '  </div>',
      '</div>'
    ].join('')
