$(function () {
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    ...
    var tabsHTML = '<ul class="nav">' +
        '<li><a rel="noopener" href="#home">Home</a></li>' +
        '<li><a rel="noopener" href="#profile">Profile</a></li>' +
        '</ul>'
  ...
  QUnit.test('should activate element by tab id in nav list', function (assert) {
    ...
    var tabsHTML =  '<nav class="nav">' +
                      '<a rel="noopener" href="#home">Home</a>' +
  ...
  QUnit.test('should not fire shown when tab is already active', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a rel="noopener" href="#home" class="nav-link active" role="tab">Home</a></li>' +
      '<li class="nav-item"><a rel="noopener" href="#profile" class="nav-link" role="tab">Profile</a></li>' +
      '</ul>' +
  ...
  QUnit.test('should not fire shown when tab is disabled', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a rel="noopener" href="#home" class="nav-link active" role="tab">Home</a></li>' +
      '<li class="nav-item"><a rel="noopener" href="#profile" class="nav-link disabled" role="tab">Profile</a></li>' +
      '</ul>' +
      '<div class="tab-content">' +
      '<div class="tab-pane active" id="home" role="tabpanel"></div>' +
      '<div class="tab-pane" id="profile" role="tabpanel"></div>' +
  ...
  QUnit.test('show and shown events should reference correct relatedTarget', function (assert) {
    ...
    var dropHTML =
        ...
        '      <li><a rel="noopener" href="#a1-1" data-toggle="tab">1-1</a></li>' +
        '      <li><a rel="noopener" href="#a1-2" data-toggle="tab">1-2</a></li>' +
        '    </ul>' +
        '  </li>' +
        '</ul>'
  ...
  QUnit.test('selected tab should have aria-selected', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li><a rel="noopener" class="nav-item active" href="#home" toggle="tab" aria-selected="true">Home</a></li>' +
        '<li><a rel="noopener" class="nav-item" href="#profile" toggle="tab" aria-selected="false">Profile</a></li>' +
        '</ul>'
  ...
  QUnit.test('selected tab should deactivate previous selected tab', function (assert) {
    assert.expect(2)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a rel="noopener" class="nav-link active" href="#home" data-toggle="tab">Home</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" href="#profile" data-toggle="tab">Profile</a></li>' +
        '</ul>'
    var $tabs = $(tabsHTML).appendTo('#qunit-fixture')
  ...
  QUnit.test('selected tab should deactivate previous selected link in dropdown', function (assert) {
    assert.expect(3)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" href="#home" data-toggle="tab">Home</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" href="#profile" data-toggle="tab">Profile</a></li>' +
        '<li class="nav-item dropdown"><a rel="noopener" class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a rel="noopener" class="dropdown-item active" href="#dropdown1" id="dropdown1-tab" data-toggle="tab">@fat</a>' +
        '<a rel="noopener" class="dropdown-item" href="#dropdown2" id="dropdown2-tab" data-toggle="tab">@mdo</a>' +
        '</div>' +
        '</li>' +
        '</ul>'
    var $tabs = $(tabsHTML).appendTo('#qunit-fixture')
  ...
  QUnit.test('Nested tabs', function (assert) {
    ...
    var tabsHTML =
        ...
        '  <a rel="noopener" href="#x-tab2" class="nav-item nav-link active" data-toggle="tab" role="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</a>' +
        '  <a rel="noopener" href="#x-tab3" class="nav-item nav-link" data-toggle="tab" role="tab" aria-controls="x-tab3">Tab 3</a>' +
        '</nav>' +
        '<div class="tab-content">' +
        '  <div class="tab-pane" id="x-tab1" role="tabpanel">' +
        '    <nav class="nav nav-tabs" role="tablist">' +
        '      <a rel="noopener" href="#nested-tab1" class="nav-item nav-link active" data-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</a>' +
  ...
  QUnit.test('should handle removed tabs', function (assert) {
    ...
    var html = [
      ...
      '  <li class="nav-item">',
      '    <a rel="noopener" class="nav-link nav-tab" href="#profile" role="tab" data-toggle="tab">',
      ...
      '  </li>',
      '  <li class="nav-item">',
      '    <a rel="noopener" class="nav-link nav-tab" href="#references" role="tab" data-toggle="tab">',
  ...
  QUnit.test('should not add show class to tab panes if there is no `.fade` class', function (assert) {
    ...
    var html = [
      '<ul class="nav nav-tabs" role="tablist">',
      '  <li class="nav-item">',
      '    <a rel="noopener" class="nav-link nav-tab" href="#home" role="tab" data-toggle="tab">Home</a>',
      '  </li>',
      '  <li class="nav-item">',
