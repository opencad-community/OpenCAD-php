$(function () {
  ...
  QUnit.test('should render popover element', function (assert) {
    ...
    $('<a rel="noopener" href="#" title="mdo" data-content="https://twitter.com/mdo">@mdo</a>')
  ...
  QUnit.test('should store popover instance in popover data object', function (assert) {
    assert.expect(1)
    var $popover = $('<a rel="noopener" href="#" title="mdo" data-content="https://twitter.com/mdo">@mdo</a>').bootstrapPopover()
  ...
  QUnit.test('should store popover trigger in popover instance data object', function (assert) {
    assert.expect(1)
    var $popover = $('<a rel="noopener" href="#" title="ResentedHook">@ResentedHook</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover()
  ...
  QUnit.test('should get title and content from options', function (assert) {
    assert.expect(4)
    var done = assert.async()
    var $popover = $('<a rel="noopener" href="#">@fat</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        title: function () {
          return '@fat'
  ...
  QUnit.test('should allow DOMElement title and content (html: true)', function (assert) {
    ...
    var content = $('<em>¯\\_(ツ)_/¯</em>').get(0)
    var $popover = $('<a rel="noopener" href="#" rel="tooltip"/>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        html: true,
        title: title,
    ...
    // toLowerCase because IE8 will return <em>...</em>
    assert.strictEqual($('.popover .popover-body').html().toLowerCase(), '<em>¯\\_(ツ)_/¯</em>', 'content inserted')
  ...
  QUnit.test('should get title and content from attributes', function (assert) {
    assert.expect(4)
    var done = assert.async()
    var $popover = $('<a rel="noopener" href="#" title="@mdo" data-content="loves data attributes (づ｡◕‿‿◕｡)づ ︵ ┻━┻" >@mdo</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover()
      .one('shown.bs.popover', function () {
        assert.notEqual($('.popover').length, 0, 'popover was inserted')
  ...
  QUnit.test('should render popover element using delegated selector', function (assert) {
    assert.expect(2)
    var done = assert.async()
    var $div = $('<div><a rel="noopener" href="#" title="mdo" data-content="https://twitter.com/mdo">@mdo</a></div>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        selector: 'a',
        trigger: 'click'
  ...
  QUnit.test('should detach popover content rather than removing it so that event handlers are left intact', function (assert) {
    assert.expect(1)
    var $content = $('<div class="content-with-handler"><a rel="noopener" class="btn btn-warning">Button with event handler</a></div>').appendTo('#qunit-fixture')
    ...
    var $div = $('<div><a rel="noopener" href="#">Show popover</a></div>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        html: true,
        trigger: 'manual',
  ...
  QUnit.test('should fire inserted event', function (assert) {
    ...
    $('<a rel="noopener" href="#">@Johann-S</a>')
      .appendTo('#qunit-fixture')
  ...
  QUnit.test('should convert number to string without error for content and title', function (assert) {
    assert.expect(2)
    var done = assert.async()
    var $popover = $('<a rel="noopener" href="#">@mdo</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        title: 5,
        content: 7
  ...
  QUnit.test('popover should call content function only once', function (assert) {
    ...
    var $popover = $('<a rel="noopener" href="#">@Johann-S</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover({
        content: function () {
          nbCall++
