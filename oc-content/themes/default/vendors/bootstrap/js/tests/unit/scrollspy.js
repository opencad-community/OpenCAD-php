$(function () {
  ...
  QUnit.test('should only switch "active" class on current target', function (assert) {
    ...
    var sectionHTML = '<div id="root" class="active">' +
        ...
        '<ul class="nav">' +
        '<li class="nav-item"><a rel="noopener" href="#masthead">Overview</a></li>' +
        '<li class="nav-item"><a rel="noopener" href="#detail">Detail</a></li>' +
        '</ul>' +
        '</div>' +
        '</div>' +
        '</div>' +
  ...
  QUnit.test('should correctly select middle navigation option when large offset is used', function (assert) {
    ...
    var sectionHTML = '<div id="header" style="height: 500px;"></div>' +
        ...
        '<ul class="navbar-nav">' +
        '<li class="nav-item active"><a rel="noopener" class="nav-link" id="one-link" href="#one">One</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" id="two-link" href="#two">Two</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" id="three-link" href="#three">Three</a></li>' +
        '</ul>' +
        '</nav>' +
  ...
  QUnit.test('should add the active class to the correct element', function (assert) {
    ...
    var navbarHtml =
      '<nav class="navbar">' +
      '<ul class="nav">' +
      '<li class="nav-item"><a rel="noopener" class="nav-link" id="a-1" href="#div-1">div 1</a></li>' +
      '<li class="nav-item"><a rel="noopener" class="nav-link" id="a-2" href="#div-2">div 2</a></li>' +
      '</ul>' +
      '</nav>'
    var contentHtml =
  ...
  QUnit.test('should add the active class to the correct element (nav markup)', function (assert) {
    ...
    var navbarHtml =
      '<nav class="navbar">' +
      '<nav class="nav">' +
      '<a rel="noopener" class="nav-link" id="a-1" href="#div-1">div 1</a>' +
      '<a rel="noopener" class="nav-link" id="a-2" href="#div-2">div 2</a>' +
      '</nav>' +
      '</nav>'
    var contentHtml =
        '<div class="content" style="overflow: auto; height: 50px">' +
  ...
  QUnit.test('should add the active class to the correct element (list-group markup)', function (assert) {
    ...
    var navbarHtml =
      ...
      '<a rel="noopener" class="list-group-item" id="a-1" href="#div-1">div 1</a>' +
      '<a rel="noopener" class="list-group-item" id="a-2" href="#div-2">div 2</a>' +
      '</div>' +
      '</nav>'
    var contentHtml =
        '<div class="content" style="overflow: auto; height: 50px">' +
  ...
  QUnit.test('should allow passed in option offset method: position', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      var $navbar = $(
        '<nav class="navbar"' + (type === 'data' ? ' id="navbar-offset-method-menu"' : '') + '>' +
        '<ul class="nav">' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" id="li-' + type + 'm-1" href="#div-' + type + 'm-1">div 1</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" id="li-' + type + 'm-2" href="#div-' + type + 'm-2">div 2</a></li>' +
        '<li class="nav-item"><a rel="noopener" class="nav-link" id="li-' + type + 'm-3" href="#div-' + type + 'm-3">div 3</a></li>' +
        '</ul>' +
        '</nav>'
      )
      var $content = $(
