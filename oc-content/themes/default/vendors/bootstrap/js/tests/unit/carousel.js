$(function () {
  ...
  QUnit.test('should reset when slide is prevented', function (assert) {
    ...
    var carouselHTML = '<div id="carousel-example-generic" class="carousel slide">' +
        ...
        '</div>' +
        '</div>' +
        '<a rel="noopener" class="left carousel-control" href="#carousel-example-generic" data-slide="prev"/>' +
        '<a rel="noopener" class="right carousel-control" href="#carousel-example-generic" data-slide="next"/>' +
        '</div>'
  ...
  QUnit.test('should fire slide event with direction', function (assert) {
    ...
    var carouselHTML = '<div id="myCarousel" class="carousel slide">' +
        ...
        '</div>' +
        '</div>' +
        '<a rel="noopener" class="left carousel-control" href="#myCarousel" data-slide="prev">&lsaquo;</a>' +
        '<a rel="noopener" class="right carousel-control" href="#myCarousel" data-slide="next">&rsaquo;</a>' +
        '</div>'
    var $carousel = $(carouselHTML)
