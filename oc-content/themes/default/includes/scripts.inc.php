    ...
    <!-- popper.js -->
    <script type="text/javascript" src="<?php echo BASE_URL . "/" . OCTHEMES . "/" . THEME; ?>/vendors/popper.js/dist/umd/popper.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo BASE_URL . "/" . OCTHEMES . "/" . THEME; ?>/js/theme.js"></script>
    <script type="text/javascript" src="<?php echo BASE_URL . "/" . OCTHEMES . "/" . THEME; ?>/js/OpenCAD.js"></script>
