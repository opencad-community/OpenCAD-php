...
<head>
  ...
  <!-- Bootstrap -->
  <link href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/vendors/bootstrap/dist/css/bootstrap.css" rel="stylesheet">
  
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">

    <!-- Animate.css -->
  <link href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/vendors/animate.css/animate.css" rel="stylesheet">
  <!-- Datatables -->
  ...
  <!-- Custom Theme Style -->  
  <link href="<?php echo BASE_URL; ?>/oc-content/themes/<?php echo THEME; ?>/vendors/coreui/src/css/style.css" rel="stylesheet">
