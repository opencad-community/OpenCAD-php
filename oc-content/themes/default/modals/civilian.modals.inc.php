		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="new_911" method="post" action="<?php echo BASE_URL; ?>/oc-includes/civActions.php" aria-labelledby="createNewCallLabel">
					...
					<!-- ./ form-group row -->
					<div class="form-group row">
						<label class="col-md-2 control-label"><span>Description <a data-toggle="modal" href="#911CallHelpModal"><em class="fasfa-question-circle"></em></a></span></label>
						<div class="col-md-10">
			...
			<div class="modal-body">
				<form role="form" action="<?php echo BASE_URL; ?>/oc-includes/civActions.php" class="editname_modalform" method="post" aria-labelledby="editIdentityLabel">
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							<input type="text" name="civSexReq" class="form-control" id="civSexReq" value="" required />
						</div>
						<!-- ./ col-sm-9 -->
					</div>
					<!-- ./ form-group -->
					<div class="form-group row">
						<label class="col-lg-2 control-label">Hair Color</label>
						<div class="col-lg-10">
							<input type="text" name="civHairReq" class="form-control" id="civHairReq" value="" required />
						</div>
						<!-- ./ col-sm-9 -->
					</div>
					<!-- ./ form-group -->
					<div class="form-group row">
						<label class="col-lg-2 control-label">Build</label>
						<div class="col-lg-10">
							<input type="text" name="civBuildReq" class="form-control" id="civBuildReq" value="" required />
							<!-- ./ col-sm-9 -->
						</div>
						<!-- ./ form-group -->
					</div>
			...
			<div class="modal-body">
				<form role="form" action="<?php echo BASE_URL; ?>/oc-includes/civActions.php" method="post" aria-labelledby="createPlateModal">
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							<select class="form-control selectpicker" name="vehPrimaryColor" data-live-search="true" required>
								<option val=""> </option>
								<?php getColors(); ?>
							</select>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							<select class="form-control selectpicker" name="vehSecondaryColor" data-live-search="true" required>
								<option val=""> </option>
								<?php getColors(); ?>
							</select>
						</div>
