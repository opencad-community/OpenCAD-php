	<!-- Registration Modal - Law Enforcement -->
	<div class="modal" id="registerLawEnforcement" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			<h4 class="modal-title" id="lawEnforcementRegLabel"><?php echo lang_key("LAW_ENFORCEMENT_ACCESS_REQUEST"); ?></h4>
	...
	<!-- Registration Modal - First Responder -->
