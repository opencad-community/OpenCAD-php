                        ...
                        <div class="col">
                            <div class="container" style="padding:0">
                                <div class="form-group">
                                    <select class="form-control selectpicker h-100 w-100" id="dataType" name="dataType" style="width: 100%;display:flexbox" required>
                            ...
                            <div class="form-group">
                                <button onclick="return confirm('Are you sure? (This cannot be reversed.)')" type="submit" name="resetData" class="btn btn-primary btn-sm btn-block">
