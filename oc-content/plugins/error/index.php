...
<head>
    ...
    <link href="<?php echo BASE_URL; . "/" . OCTHEMES . "/" . THEME; ?>/css/custom.css" rel="stylesheet">
    <style>
        .wrapper{
            overflow:hidden;
        }
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" id="codeList">
                                ...
                                <?php } ?>
                                <div class="x_content">
                                    If this error persists, please raise up a <a rel="noopener" href="https://github.com/opencad-app/OpenCAD-php/issues/new/choose">bug report</a> on GitHub.
                                </div>
                            </div>
                        </div>
                    </div>
