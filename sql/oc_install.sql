...
CREATE TABLE `<DB_PREFIX>activeusers` (
  ...
  `callsign` varchar(255) CHARACTER SET latin1 NOT NULL COMMENT 'Unit Callsign',
...
CREATE TABLE `<DB_PREFIX>ncic_names` (
  ...
  `dob` varchar(11) DEFAULT NULL COMMENT 'Date of birth',
...
CREATE TABLE `<DB_PREFIX>ncic_plates` (
  ...
  `flags` set('STOLEN','WANTED','SUSPENDED REGISTRATION','CANCELED REGISTRATION','EXPIRED REGISTRATION','INSURANCE FLAG','DRIVER FLAG','NO INSURANCE') DEFAULT NULL,
  `vehRegState` set('Los Santos','Blaine County','San Andreas','Unknown') DEFAULT 'Unknown',
...
CREATE TABLE `<DB_PREFIX>users` (
  ...
  `civilianPrivilege` int(1) DEFAULT NULL,
