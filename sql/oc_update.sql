...
ALTER TABLE `<DB_PREFIX>departments` CHANGE `department_short_name` `department_short_name` 
...
ALTER TABLE `<DB_PREFIX>departments` CHANGE `department_long_name` `department_long_name` 
