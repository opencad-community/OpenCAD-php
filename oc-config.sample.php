 ...
 * But be warned! If you reset these, you will have to delete all entries within the DB that are encrypted using these keys. 
 * Below is a list of all entries that are encrpyted and will need to be manually deleted and re-entered:
 * 
 * <DB_PREFIX>_config -> gh_key
 * <DB_PREFIX>_webhooks -> All Webhook URLs are encrypted only displayed in clear text on the webhook manager page.
 * 
 * Since version 1.0.0, these keys are used to encrypt your personal API keys that are entered within the Datbase. 
 * If you share any of the below keys with ANYONE you risk having your data decrypted and leaked. 
 * This is your only warning, DO NOT share any of the below details.
 * 
 * These are also automatically generated by the installer during the "Core Configuration" step.
 * 
